...
NOTE: When viewing the list of tables in vms database. if `\dt` will give the output of `Did not find any relations.` then `\dt[S+]` will give the desired list of table.
